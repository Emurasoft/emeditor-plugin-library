...
#define HISTORY_SEL_CELL			0x80000000L  // v22.4
...
inline HRESULT Editor_RunMacro( HWND hwnd, UINT nFlags, UINT nDefMacroLang, LPCWSTR pszMacroFile, LPCWSTR pszText, const POINT_PTR* pptOrgPos, const POINT_PTR* pptCodePos, POINT_PTR* pptErrorPos, HGLOBAL* phstrResult )
{
	_ASSERT( hwnd && IsWindow( hwnd ) );
...
#define CI_GET_CLIP_TYPE			7
#define CI_CLIP_AVAILABLE			8
#define CI_TYPE_MASK				0x0000000f
#define CI_FLAG_NO_UPDATE_REAL_CLIP	0x00001000
#define CI_FLAG_HTML				0x00002000
#define CI_DIABLE_ALTERNATE_TYPE	0x00004000
...
#define SORT_MOVE_CURSOR						0x00000800		
...
#define SORT_DIGIT_GROUPING						0x00000040
...
#define SORT_MASK_ALL			(SORT_MASK | SORT_IGNORE_PREFIX | SORT_LENGTH_VIEW | SORT_STABLE | SORT_BINARY_COMPARISON | SORT_UNQUOTE_CELLS | SORT_INSPECT_NOT_SEL_ONLY | SORT_GROUP_IDENTICAL | SORT_DIGIT_GROUPING | SORT_MOVE_CURSOR)
...
#define DEF_SORT_OPTIONS		(SORT_IGNORE_PREFIX | SORT_BINARY_COMPARISON | SORT_GROUP_IDENTICAL)
...
#define COMPARE_SPLIT_VERT				(COMPARE_TILE_VERT | COMPARE_TILE_HORZ)
#define COMPARE_TILE_SPLIT_MASK			(COMPARE_TILE_VERT | COMPARE_TILE_HORZ)
...
#define COMPARE_QUICK					0x20000000
...
#define FREQ_TYPE_URI		5
#define FREQ_TYPE_EMAIL		6
...
#define EE_GET_SEL_LENGTH       (EE_FIRST+133)
// (size_t)wParam = nMaxLen;

inline UINT_PTR Editor_GetSelLength( HWND hwnd, size_t nMaxLen = 0 )
{
	_ASSERT( hwnd && IsWindow( hwnd ) );
...
#define FLAG_INDENT					0x000e
#define FLAG_UNINDENT				0x000f
...
#define FLAG_FIND_TRUNCATE				0x0000'0000'0000'8000ull  // EE_FIND_IN_FILES only
...
#define FLAG_FIND_FUZZY					0x0001'0000'0000'0000ull
...
#define FLAG_FIND_MULTI					0x0010'0000'0000'0000ull
...
#define FLAG_GREP_MASK				   (0x0000'0007'0604'7f46ull | FLAG_FIND_OUTPUT | FLAG_FIND_FILTER | FLAG_FIND_NUMBER_RANGE | FLAG_FIND_COUNT_FREQUENCY | FLAG_FIND_OUTPUT_ENCODING | FLAG_FIND_MATCHED_EX | FLAG_FIND_FUZZY | FLAG_FIND_TRUNCATE)
...
#define FLAG_FIND_MASK_WITHOUT_EXTRACT (0x0000'0007'283f'83ffull | FLAG_FIND_BOL_EOL | FLAG_FIND_LOOKAROUND | FLAG_FIND_NO_OVERLAP | FLAG_FIND_INSERT_COLUMN | FLAG_FIND_NUMBER_RANGE | FLAG_FIND_FUZZY)
#define FLAG_FIND_MASK					(FLAG_FIND_MASK_WITHOUT_EXTRACT | FLAG_FIND_EXTRACT_MASK)
#define FLAG_BATCH_FIND_MASK			(FLAG_FIND_CASE | FLAG_FIND_ONLY_WORD | FLAG_FIND_REG_EXP | FLAG_FIND_NUMBER_RANGE | FLAG_FIND_ESCAPE | FLAG_FIND_LINK_FILE | FLAG_FIND_FUZZY)
#define FLAG_BATCH_GREP_MASK			FLAG_BATCH_FIND_MASK
#define FLAG_FILTER_MASK				(FLAG_FIND_CASE | FLAG_FIND_ESCAPE | FLAG_FIND_ONLY_WORD | FLAG_FIND_REG_EXP | FLAG_FIND_INCREMENTAL | FLAG_FIND_NEGATIVE | FLAG_FIND_NUMBER_RANGE | FLAG_FIND_FUZZY)
...
#define FLAG_FIND_SAVE_UNIQUE_MASK		(FLAG_FIND_IGNORE_BINARY | FLAG_FIND_SHOW_IGNORED | FLAG_FIND_OUTPUT | FLAG_FIND_FILTER | FLAG_FIND_FILENAMES_ONLY | FLAG_FIND_OUTPUT_DISPLAY | FLAG_GREP_NO_CLOSE | FLAG_FIND_TRUNCATE)  // internal use only

#define DEFAULT_FIND_FLAG				(FLAG_FIND_AROUND | FLAG_FIND_OUTPUT_DISPLAY)
#define DEFAULT_GREP_FLAG				(FLAG_FIND_SHOW_IGNORED | FLAG_FIND_TRUNCATE)
...
#define FLAG_GREP_EXTRACT_MASK          (FLAG_FIND_OUTPUT_DISPLAY | FLAG_FIND_FILENAMES_ONLY | FLAG_FIND_MATCHED_EX | FLAG_FIND_COUNT_FREQUENCY | FLAG_FIND_OUTPUT | FLAG_FIND_TRUNCATE)
...
#define VALIDATOR_TYPE_LSP			0x50
...
#define LSP_TYPE_CSS				0x01
#define LSP_TYPE_JS					0x02
...
#define RENAME_BACKUP_ENABLED		1
#define RENAME_BACKUP_DATETIME		2
...
public:
    ...
    BYTE        m_nCheckFileChanged; // v3: changed by another program  (0 - MAX_CHECK_FILE_CHANGED-1)
	bool		m_bCheckFileDeleted;  // v23.2
	BYTE		m_byteDummy17;
	BYTE		m_byteDummy18;
	UINT		m_nDummy;
	...
	BYTE		m_byteLsp;           // was m_bHighlightCharRef  v11 Highlight HTML/XML Character Reference and Universal Character Names -> replaced with m_pConfig->m_cust.m_nAS & AS_BIT_HTML_CHAR_REF or AS_BIT_UCN
    ...
    BYTE        m_bRenameBackup;            // PRO only rename if same file name exists
...
#define EEID_INSERT_SNIPPET1              30208 // to EEID_INSERT_SNIPPET1 + 1023
...
#define EEID_CUSTOMIZE_SNIPPETS           9081
