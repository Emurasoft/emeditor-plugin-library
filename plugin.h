...
inline int Editor_Compare( HWND hwnd, UINT nFlags, LPCWSTR pszDocument1, LPCWSTR pszDocument2, LPCWSTR pszResultFileName )
{
	...
	return (int)SNDMSG( (hwnd), EE_COMPARE, (LPARAM)&ci, 0 );
}
//
...
#define FLAG_FIND_NEXT					0x0000'0000'0000'0001i64  // EE_FIND only
#define FLAG_FILTER_ENABLED				0x0000'0000'0000'0001i64  // internal use only
#define FLAG_FIND_CASE					0x0000'0000'0000'0002i64  // EE_FIND, EE_REPLACE, EE_FIND_IN_FILES and EE_REPLACE_IN_FILES, EE_MATCH_REGEX and EE_FIND_REGEX
#define FLAG_FIND_ESCAPE				0x0000'0000'0000'0004i64  // EE_FIND and EE_REPLACE, EE_FIND_IN_FILES and EE_REPLACE_IN_FILES
#define FLAG_REPLACE_SEL_ONLY			0x0000'0000'0000'0008i64  // EE_REPLACE only
#define FLAG_FIND_DETECT_WORD			0x0000'0000'0000'0008i64  // internal use only for "AddOccurrenceFlags" entry
#define FLAG_REPLACE_ALL				0x0000'0000'0000'0010i64  // EE_REPLACE only
#define FLAG_FIND_NO_PROMPT				0x0000'0000'0000'0020i64  // EE_FIND and EE_REPLACE
#define FLAG_FIND_ONLY_WORD				0x0000'0000'0000'0040i64  // EE_FIND, EE_REPLACE, EE_FIND_IN_FILES and EE_REPLACE_IN_FILES, and EE_FIND_REGEX
#define FLAG_FIND_AROUND				0x0000'0000'0000'0080i64  // EE_FIND only
#define FLAG_FIND_IGNORE_BINARY			0x0000'0000'0000'0080i64  // EE_FIND_IN_FILES and EE_REPLACE_IN_FILES (same as FLAG_FIND_AROUND) v15.1  // should be saved as "GrepFlag" entry
#define FLAG_FIND_REG_EXP				0x0000'0000'0000'0100i64  // EE_FIND, EE_REPLACE, EE_FIND_IN_FILES and EE_REPLACE_IN_FILES
#define FLAG_FIND_CLOSE					0x0000'0000'0000'0200i64  // EE_FIND and EE_REPLACE
#define FLAG_FIND_SHOW_IGNORED			0x0000'0000'0000'0200i64  // EE_FIND_IN_FILES and EE_REPLACE_IN_FILES (same as FLAG_FIND_CLOSE) v15.1  // should be saved as "GrepFlag" entry
#define FLAG_FIND_RECURSIVE				0x0000'0000'0000'0400i64  // EE_FIND_IN_FILES and EE_REPLACE_IN_FILES
#define FLAG_FIND_LOGICAL_OR			0x0000'0000'0000'0400i64  // EE_FILTER  (the value same as FLAG_FIND_RECURSIVE)
#define FLAG_FIND_FILENAMES_ONLY		0x0000'0000'0000'0800i64  // EE_FIND_IN_FILES only
#define FLAG_REPLACE_KEEP_OPEN			0x0000'0000'0000'1000i64  // EE_REPLACE_IN_FILES only
#define FLAG_FIND_CONTINUE				0x0000'0000'0000'1000i64  // EE_FILTER  (the value same as FLAG_REPLACE_KEEP_OPEN)
#define FLAG_REPLACE_BACKUP				0x0000'0000'0000'2000i64  // EE_REPLACE_IN_FILES only
#define FLAG_FIND_KEEP_PREVIOUS			0x0000'0000'0000'2000i64  // EE_FILTER  (the value same as FLAG_REPLACE_BACKUP)
#define FLAG_FIND_IGNORE_FILES			0x0000'0000'0000'4000i64  // EE_FIND_IN_FILES and EE_REPLACE_IN_FILES
#define FLAG_FIND_REMOVE_LAST			0x0000'0000'0000'4000i64  // EE_FILTER  (the value same as FLAG_FIND_IGNORE_FILES)
#define FLAG_FIND_OPEN_DOC				0x0000'0000'0000'8000i64  // EE_FIND and EE_REPLACE
#define FLAG_FIND_MATCH_DOT_NL			0x0000'0000'0001'0000i64  // internal use only
#define FLAG_FIND_INCREMENTAL			0x0000'0000'0002'0000i64  // internal use only
#define FLAG_FIND_SAVE_HISTORY			0x0000'0000'0004'0000i64  // EE_FIND, EE_REPLACE, EE_FIND_IN_FILES and EE_REPLACE_IN_FILES
#define FLAG_FIND_COUNT					0x0000'0000'0008'0000i64  // EE_FIND
#define FLAG_FIND_BOOKMARK				0x0000'0000'0010'0000i64  // EE_FIND
#define FLAG_FIND_SELECT_ALL			0x0000'0000'0020'0000i64  // EE_FIND
#define FLAG_FIND_WHOLE_STRING			0x0000'0000'0040'0000i64
#define FLAG_FIND_OUTPUT				0x0000'0000'0100'0000i64  // EE_FIND_IN_FILES only
#define FLAG_FIND_OUTPUT_DISPLAY		0x0000'0000'0200'0000i64  // EE_FIND_IN_FILES only (v14)
#define FLAG_GREP_NO_CLOSE				0x0000'0000'0400'0000i64  // EE_FIND_IN_FILES and EE_REPLACE_IN_FILES (v14)
#define FLAG_FIND_EXTRACT				0x0000'0000'0800'0000i64  // EE_FIND
#define FLAG_FIND_FILTER				0x0000'0000'1000'0000i64  // internal use only
#define FLAG_FIND_EMBEDDED_NL			0x0000'0000'2000'0000i64  // EE_FIND, EE_REPLACE and EE_FILTER for CSV embedded new lines
#define FLAG_FIND_NEGATIVE				0x0000'0000'4000'0000i64  // EE_FILTER
#define FLAG_FIND_UPDATE_MARKER			0x0000'0000'8000'0000i64  // internal use only
#define FLAG_FIND_EXTRACT_FILE_LINE		0x0000'0000'8000'0000i64  // internal use only for macros
#define FLAG_FILTER_DISABLED			0x0000'0000'8000'0000i64  // internal use only
#define FLAG_FIND_SEPARATE_CRLF			0x0000'0001'0000'0000i64
#define FLAG_FIND_REGEX_BOOST			0x0000'0002'0000'0000i64
#define FLAG_FIND_REGEX_ONIGMO			0x0000'0004'0000'0000i64
//#define FLAG_FIND_COLUMN				0x0000'0008'0000'0000i64  // EE_FIND only
#define FLAG_FIND_INSERT_COLUMN			0x0000'0010'0000'0000i64  // EE_REPLACE only
#define FLAG_FIND_MATCH_NL				0x0000'0020'0000'0000i64
#define FLAG_FIND_CR_ONLY				0x0000'0040'0000'0000i64
#define FLAG_FIND_LF_ONLY				0x0000'0080'0000'0000i64
#define FLAG_FIND_CR_LF					0x0000'0100'0000'0000i64
#define FLAG_FIND_NL_OTHERS				0x0000'0200'0000'0000i64
#define FLAG_FIND_BOOKMARKED_ONLY		0x0000'0400'0000'0000i64
#define FLAG_FIND_UNBOOKMARKED_ONLY		0x0000'0800'0000'0000i64
#define FLAG_FIND_NUMBER_RANGE			0x0000'1000'0000'0000i64  // EE_FILTER only
#define FLAG_FIND_BEGIN_NL				0x0010'0000'0000'0000i64  // internal use only
#define FLAG_FIND_END_NL				0x0020'0000'0000'0000i64  // internal use only
#define FLAG_FIND_NO_OVERLAP			0x0040'0000'0000'0000i64
#define FLAG_FIND_LOOKAROUND			0x0080'0000'0000'0000i64
#define FLAG_FIND_REPLACE_LATER			0x0100'0000'0000'0000i64  // internal use only
#define FLAG_FIND_BOL					0x0200'0000'0000'0000i64
#define FLAG_FIND_EOL					0x0400'0000'0000'0000i64
#define FLAG_FIND_SINGLE_LINE			0x0800'0000'0000'0000i64  // internal use only
#define FLAG_FIND_ADD_NEXT				0x4000'0000'0000'0000i64  // EE_FIND internal use only
#define FLAG_FIND_NO_DESELECT			0x8000'0000'0000'0000i64  // EE_FIND internal use only
...
#define FLAG_GREP_MASK				   (0x0000'0007'0604'7d46i64 | FLAG_FIND_OUTPUT | FLAG_FIND_FILTER | FLAG_FIND_NUMBER_RANGE)
#define FLAG_FIND_EXTRACT_MASK			(FLAG_FIND_FILENAMES_ONLY | FLAG_FIND_OUTPUT_DISPLAY | FLAG_FIND_OUTPUT)
#define FLAG_FIND_MASK_WITHOUT_EXTRACT (0x0000'0007'283f'83ffi64 | FLAG_FIND_BOL_EOL | FLAG_FIND_LOOKAROUND | FLAG_FIND_INSERT_COLUMN | FLAG_FIND_NUMBER_RANGE)
